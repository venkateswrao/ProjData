...
<form action="<?php echo base_url();?>home/checkuser" method="POST">
			...
			<fieldset>
				...
				<p><label for="email">E-mail address</label></p><span id="error1"></span>
				<p><input type="email" name="email" id="email" required="required" value="mail@address.com" onBlur="if(this.value=='')this.value='mail@address.com'" onFocus="if(this.value=='mail@address.com')this.value=''"></p> <!-- JS because of IE support; better: placeholder="mail@address.com" -->

				<p><label for="password">Password</label></p>
				<p><input type="password" name="pwd" id="password" required="required" value="password" onBlur="if(this.value=='')this.value='password'" onFocus="if(this.value=='password')this.value=''"></p> <!-- JS because of IE support; better: placeholder="password" -->
